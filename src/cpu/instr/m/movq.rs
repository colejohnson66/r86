...
impl Movq {
    ...
    fn qq_pq(_cpu: &mut Cpu, _instr: &Instr) -> u32 {
        unimplemented!();
    }
    ...
    fn wq_vdq(_cpu: &mut Cpu, _instr: &Instr) -> u32 {
        unimplemented!();
    }

    fn v_eq_vdq_v128(_cpu: &mut Cpu, _instr: &Instr) -> u32 {
        unimplemented!();
    }

    fn v_eq_vdq_e128(_cpu: &mut Cpu, _instr: &Instr) -> u32 {
        unimplemented!();
    }
}

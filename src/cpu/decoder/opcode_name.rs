...
pub enum OpcodeName {
    ...
    // [EVEX.128.66.0F3A.W0 16 /r ib] VPEXTRW r/m32, xmm1, imm8
    ...
    // [VEX.256.66.0F38.WIG 20 /r] VPMOVSXBW ymm1, ymm2/m128
    VPMOVSXBW_VqqWqq_V256,
